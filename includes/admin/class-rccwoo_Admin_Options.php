...
if( ! class_exists( 'rccwoo_Admin_Options' ) ) {	
	class rccwoo_Admin_Options {
		...
		public function register_plugin_settings() { 
			...
			add_settings_field( 
				'rccwoo_radiobox_1', 
				'<span class="option-name">' . __( 'Side (float)', 'racar-clear-cart-for-woocommerce' ) . '<span class="quick-exp">(' . __( 'Choose at what side from the update cart button<br>should the clear cart button be', 'racar-clear-cart-for-woocommerce' ) . ')</span></span>', 
		...
		public function sanitize( $input ) {
			...
			if ( ! empty( $_POST ) && check_admin_referer( 'rccwoo_update_options', 'nonce_rccwoo_settings' ) ) {
				...
				if( isset( $input['rccwoo_background_hover_color'] ) ) {
		...
		public function plugin_settings_section_callback() { 
			echo __( 'Enter your preferences below:', 'racar-clear-cart-for-woocommerce' );
		}
		...
		public function rccwoo_button_text_render() { 
			printf(
				...
				__('Clear Cart','racar-clear-cart-for-woocommerce')
			);
		}
		...
		public function rccwoo_confirm_text_render() { 
			printf(
				...
				__('Are you sure you wish to clear your shopping cart?','racar-clear-cart-for-woocommerce')
			);
		}
		...
		public function rccwoo_redirection_url_render() { 
			printf(
				...
				__( 'https://mysite.com/shop' , 'racar-clear-cart-for-woocommerce' )
			);
			echo '<div>'. __('Leave blank to keep customer in cart page after cart deletion' , 'racar-clear-cart-for-woocommerce' ) . '</div>';
		}
